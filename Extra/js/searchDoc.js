function searchDoctors() {
    ...
    else if (cityInput.toLowerCase() === "shirpur") {
        doctorLocations = [
            { name: "Doctor P", lat: 21.35,lng: 74.87 },
            { name: "Doctor Q", lat: 21.35,lng: 74.87 },
            { name: "Clinic AQ", lat: 21.34, lng: 74.88 }
        ];
    }
    else if (cityInput.toLowerCase() === "chopda") {
        doctorLocations = [
            { name: "Doctor PA", lat: 21.24, lng: 75.30 },
            { name: "Doctor QB", lat: 21.24, lng: 75.29 },
            { name: "Clinic AQ", lat: 21.23,lng: 75.29 }
        ];
    }else {
